  ...
  return (
    <div className="row center">
      <Link to={`/search/category/Buku%20dan%20Alat%20Tulis/name/${name}`}>
        <div className="card-category card-body">Buku dan Alat Tulis</div>
      </Link>
      <Link to={`/search/category/Komputer%20dan%20Aksesoris/name/${name}`}>
        <div className="card-category card-body">Komputer dan Aksesoris</div>
      </Link>
      <Link to={`/search/category/Baju%20dan%20Celana/name/${name}`}>
        <div className="card-category card-body">Baju dan Celana</div>
      </Link>
      <Link to={`/search/category/Sepatu%20dan%20Sendal/name/${name}`}>
        <div className="card-category card-body">Sepatu dan Sendal</div>
      </Link>
      <Link to={`/search/category/Kebutuhan%20Kampus/name/${name}`}>
        <div className="card-category card-body">Kebutuhan Kampus</div>
      </Link>
      <Link to={`/search/category/Olahraga/name/${name}`}>
        <div className="card-category card-body">Olahraga</div>
      </Link>
      <Link to={`/search/category/Tas/name/${name}`}>
        <div className="card-category card-body">Tas</div>
      </Link>
      <div className="card-category card-body">
        <div className="dropdown-category">
          ...
          <ul className="dropdown-content-category">
            ...
            <li>
              <Link
                to={`/search/category/Handphone%20dan%20Aksesoris/name/${name}`}
              >
            ...
            <li>
              <Link to={`/search/category/Lainnya/name/${name}`}>Lainnya</Link>
            </li>
          </ul>
        </div>
      </div>
